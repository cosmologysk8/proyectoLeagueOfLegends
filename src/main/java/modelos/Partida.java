...
public class Partida {
    ...
    public Partida(Partida p){
        ...
        this.elecciones = p.getElecciones();
        this.jugadoresPorEquipo = p.getJugadoresPorEquipo();
        this.inicioPartida = p.getInicioPartida();
        this.finPartida = p.getFinPartida();
        this.duracionPartida = p.getDuracionPartida();
        this.equipoVencedor = p.getEquipoVencedor();

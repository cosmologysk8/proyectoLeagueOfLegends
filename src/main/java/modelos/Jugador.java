...
public class Jugador {
    ...
    public Jugador(Jugador up) {
        this.id = up.getId();
        this.nickname = up.getNickname();
        this.personajesFavoritos = up.getPersonajesFavoritos();
        this.partidasGanadas = up.getPartidasGanadas();
    }
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(nickname, that.nickname) && Objects.equals(personajesFavoritos, that.personajesFavoritos) && Objects.equals(partidasGanadas, that.partidasGanadas);
    }

import ficheros.documentos.UtilidadesFichero;
import ficheros.documentos.UtilidadesItem;
import modelos.*;
...
public class PruebaMetodos {
            ...
            public void inicializadoDeDatos() throws Exception {
                ...
                //----------------------- PERSONAJES -------------------------------------
                Personaje p = new Personaje(1,"Lux",LocalDate.now(),"Campeona de luz", 0,100D , 100D ,100D ,100D ,100D
                        ,100D ,100D ,100D ,Region.DEMACIA ,new ArrayList<>(), new ArrayList<>(),null );
                Personaje p2 = new Personaje(2,"El Explorador",LocalDate.now(), "Ezreal" , 0, 0D, 0D,
                        0D, 0D, 105D, 105D, 105D, 105D, Region.PILTOVER, new ArrayList<>(), new ArrayList<>(), null);
                Personaje p3 = new Personaje(3,"Sion",LocalDate.now(), "Titán", 0, 0D, 0D,
                        0D, 0D, 140D, 140D, 140D, 140D, Region.NOXUS, new ArrayList<>(), new ArrayList<>(), null);
                Personaje p4 = new Personaje(4,"Miss Fortune",LocalDate.now(), "Pistolas",  0, 0D, 0D,
                        0D, 0D, 130D, 130D, 130D, 130D, Region.AGUAS_ESTANCADAS, new ArrayList<>(), new ArrayList<>(), null);
                Personaje p5 = new Personaje(5,"Gankplank",LocalDate.now(), "Pirata",  0, 0D, 0D,
                ...
                //---------------------- HABILIDADES -----------------------------------------
                Habilidad h = new Habilidad(1, "Disparo Arcano", 20D, 0D, 10D, TipoHabilidad.Dayo);
                Habilidad h1 = new Habilidad(2, "Singularidad Brillante", 30D, 0D, 20D, TipoHabilidad.Dayo);
                ...
                p2.setEscabilidad(e);
                p3.setEscabilidad(e);
                p4.setEscabilidad(e2);
                p5.setEscabilidad(e2);
            ...
            public void testLeerItemsFichero() throws IOException {
                ...
                itemsLeidos.forEach(i->{
                    ...
                    assertNotNull(i.getAumentoDayo());
